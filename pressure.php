...
<div class="bigElem">
<div class="elem_head">Ciśnienie - wykres</div>
	<div class="roomContainer">
		<div class="roomSubContainer">
		<span>
			<button type="button" class="btn1" value="dd" onclick="getDataToChart('Pressure','dd',chartObject);">Pobierz dane</button>
			Data - od: 
		...
		<div class="roomSubContainer">
		<button type="button" class="btn1" value="dd" id="bt1" onclick="getDataToChart('Pressure','dz',chartObject);">Pobierz dane</button>
...
<!--histogram-->
<div class="bigElem">
<div class="elem_head">Ciśnienie - histogram</div>
...
getHist('Pressure',1,histObject)


getDataToChart('Pressure','dz',chartObject);
reportWindowSize(chartObject)
function cath(){chartObject.plot(dataY,dataX);}
cath()
getDataFromDB("Pressure")
