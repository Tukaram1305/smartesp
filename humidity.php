...
<div class="bigElem">
<div class="elem_head">Wilgotność powietrza - wykres</div>
	<div class="roomContainer">
		<div class="roomSubContainer">
		<span>
			<button type="button" class="btn1" value="dd" onclick="getDataToChart('Humidity','dd',chartObject);">Pobierz dane</button>
			Data - od: 
		...
		<div class="roomSubContainer">
		<button type="button" class="btn1" value="dd" id="bt1" onclick="getDataToChart('Humidity','dz',chartObject);">Pobierz dane</button>
...
<!--histogram-->
<div class="bigElem">
<div class="elem_head">Wilgotność - histogram</div>
...
<!-- glowny canvas bigCan -->
<div class="bigElem">
<div class="elem_head">Wilgotność powietrza - zestawienie tabelaryczne</div>
...
getHist('Humidity',0.25,histObject)

getDataToChart('Humidity','dz',chartObject);
reportWindowSize(chartObject)
function cath(){chartObject.plot(dataY,dataX);}
cath()
getDataFromDB("Humidity")
